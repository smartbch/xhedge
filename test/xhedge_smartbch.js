...
contract("XHedgeForSmartBCH", async (accounts) => {
    ...
    it('burn', async () => {
        const hedgeValue = 600n * _1e18 * 20000000n;
        const amt = (_1e18 + initCollateralRate) * hedgeValue / initOraclePrice;
        const result0 = await createVaultWithDefaultArgs({hedgeValue: hedgeValue, amt: amt});
    ...
    it('liquidate_priceFall_byHedgeOwner', async () => {
        const hedgeValue = 600n * _1e18 * 20000000n;
        const amt = (_1e18 + initCollateralRate) * hedgeValue / initOraclePrice;
        const result0 = await createVaultWithDefaultArgs({matureTime: 1, hedgeValue: hedgeValue, amt: amt});
        // const result0 = await createVaultWithDefaultArgs({matureTime: 1});
        const [leverId, hedgeId, sn] = getTokenIds(result0);
        // console.log(leverId, hedgeId, sn);
